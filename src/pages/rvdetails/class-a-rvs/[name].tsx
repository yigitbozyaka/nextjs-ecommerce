  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content={`Check more about ${rvDetails.year} ${rvDetails.make} & ${rvDetails.model} RV Model.`}
        />
        <meta
          name="keywords"
          content={`rv, rvs, luxury rv, cheap rv, modern rv, ${rvDetails.make} & ${rvDetails.model}, ${rvDetails.make}, ${rvDetails.model}`}
        />
        <meta
          property="og:url"
          content={`https://highwayhomes.store/rvdetails/class-a-rvs/${slug}`}
        />
        <meta
          property="og:title"
          content={`${rvDetails.year} ${rvDetails.make} & ${rvDetails.model} | HighwayHomes`}
        />
        <meta
            ...
            <div className="flex flex-row justify-between my-10">
              <div className="flex flex-col">
                ...
                <div className="font-bold text-2xl">
                  ${formatNumberWithCommas(rvDetails.price)}.00
                </div>
              </div>
              <div className="flex flex-col">
      ...
      {rvDetails.description1 && (
        <div
          className="mx-6 xl:mx-0 flex flex-col items-center justify-center my-10"
          id="description"
        >
