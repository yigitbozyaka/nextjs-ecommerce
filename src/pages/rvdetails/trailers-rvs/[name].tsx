  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={`Check more about ${rvDetails.year} ${rvDetails.make} & ${rvDetails.model} Trailer Model.`} />
        <meta name="keywords" content={`rv, rvs, luxury rv, cheap rv, modern rv, trailers, trailer, ${rvDetails.make} & ${rvDetails.model}, ${rvDetails.make}, ${rvDetails.model}`} />
        <meta property="og:url" content={`https://highwayhomes.store/rvdetails/trailers-rvs/${slug}`} />
        <meta property="og:title" content={`${rvDetails.year} ${rvDetails.make} & ${rvDetails.model} | HighwayHomes`} />
        <meta property="og:description" content={`Check more about ${rvDetails.year} ${rvDetails.make} & ${rvDetails.model} Trailer Model.`} />
      </Head>
